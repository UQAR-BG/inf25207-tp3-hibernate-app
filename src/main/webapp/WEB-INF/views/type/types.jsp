            ...
            <div class="row mt-4">
                <c:choose>
                    <c:when test="${types == null || types.isEmpty()}">
                        <h4>Aucun type d'avion.</h4>
                    </c:when>
                    <c:otherwise>
                        <jsp:include page="_typeList.jsp"/>
                    </c:otherwise>
                </c:choose>
                <a href="<spring:url value="/type/add" />">
                    <i class="fa fa-plus"></i><span class="mx-2">Ajouter un type d'avion</span>
                </a>
            </div>
        </div>
