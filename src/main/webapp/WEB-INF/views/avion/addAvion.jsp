        ...
        <div class="container">
            <div class="row mt-4">
                ...
                <div class="col-6">
                    ...
                    <form:form class="form my-4" method="POST" action="/avion/save" modelAttribute="avion">
                        <div class="form-group mt-3">
                            <form:label path="type">Type d'avion</form:label>
                            <form:select class="form-select" id="inputType" path="type" cssErrorClass="form-control is-invalid">
                                <form:option value="-1" label="Sélectionnez un type d'avion ..."/>
